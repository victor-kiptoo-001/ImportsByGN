...
export const getDashboardStats = tryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key))
        ...
        const latestTransactionPromise = Order.find({})
            ...
            .limit(4);
        const [thisMonthProducts, lastMonthProducts, thisMonthUsers, lastMonthUsers, thisMonthOrders, lastMonthOrders, productCount, userCount, allOrders, lastSixMonthOrders, categories, femaleUsersCount, latestTransaction,] = await Promise.all([
...
export const getPieChart = tryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key))
        ...
        const [processingOrders, shippedOrders, deliveredOrders, categories, productCount, productOutOfStock, allOrders, allUsers, adminUsers, customerUsers,] = await Promise.all([
